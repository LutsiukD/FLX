...
/* harmony import */ var _playGame__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./playGame */ "./src/js/playGame.js");
...
rockBtn.onclick = () => {
  console.log('log');
  myMove = 'Rock';
  Object(_playGame__WEBPACK_IMPORTED_MODULE_0__["default"])();
};
...
const playGame = () => {
  if (myWins < 3 && compWins < 3) {
    ...
    if (myMove === 'Scissors' && compMove === 'Paper' || myMove === 'Paper' && compMove === 'Rock' || myMove === 'Rock' && compMove === 'Scissors') {
      myWins++;
      rounds++;
      printLogs('WON');
    } else if (myMove === 'Paper' && compMove === 'Scissors' || myMove === 'Rock' && compMove === 'Paper' || myMove === 'Scissors' && compMove === 'Rock') {
      compWins++;
      rounds++;
      printLogs('LOST');
